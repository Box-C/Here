...
if (_action) then {
    if (getOutVehicle < _upgradePrice) exitWith {
        hint parseText format [
            ...
            [getOutVehicle] call life_fnc_numberText,
            [_upgradePrice - getOutVehicle] call life_fnc_numberText
        ];
    };
    getOutVehicle = getOutVehicle - _upgradePrice;
