...
((findDisplay 5200) displayCtrl 3) ctrlAddEventHandler ["ButtonClick",{
	...
	closeDialog 0;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Underglow successfully added, press SHIFT-Q to activate<br/><t color='#12FE00'>$%1</t> left</t>",[life_pulloutallplayers] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
...
((findDisplay 5200) displayCtrl 4) ctrlAddEventHandler ["ButtonClick",{
	...
	// Refund money
	life_pulloutallplayers = life_pulloutallplayers + mav_tuning_rgbprice;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'><t color='#12FE00'>$%1</t> have been refunded to your account<br/><t color='#12FE00'>$%2</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[life_pulloutallplayers] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
