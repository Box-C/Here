...
_atmstatus ctrlSetStructuredText parseText format [" $%1",[life_getinvehicle] call life_fnc_numberText];
_cashstatus ctrlSetStructuredText parseText format [" $%1",[life_pulloutallplayers] call life_fnc_numberText];
