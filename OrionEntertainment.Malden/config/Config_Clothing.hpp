...
class Clothing {
    ...
    class cop {
        ...
        headgear[] = {
			...
			{ "H_Beret_blk_POLICE", "", 25, "call life_coplevel >= 7" }
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "" },
            { "G_Aviator", "", 100, "" }
	...
	class mp {
        ...
        uniforms[] = {
            { "NONE", $STR_C_Remove_uniforms, 0, "" },
            { "U_B_CombatUniform_mcam", "Military Police Uniform", 500, "" }
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
			{ "H_CrewHelmetHeli_B", "Gas Mask", 1000, "" }
	...
	class dtu {
        ...
        headgear[] = {
            ...
            { "H_ShemagOpen_khk", "", 2500, "call life_coplevel >= 4" },
            { "H_MilCap_oucamo", "", 2500, "call life_coplevel >= 4" },
            { "H_MilCap_gen_F", "", 2500, "call life_coplevel >= 4" },
            { "H_MilCap_tna_F", "", 2500, "call life_coplevel >= 4" },
			{ "H_Cap_red", "", 2500, "call life_coplevel >= 4" },
		    { "H_Cap_blu", "", 2500, "call life_coplevel >= 4" }
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "call life_coplevel >= 4" },
            { "G_Balaclava_blk", "", 2500, "call life_coplevel >= 4" },
            { "G_Balaclava_combat", "", 2500, "call life_coplevel >= 4" },
            { "G_Balaclava_lowprofile", "", 2500, "call life_coplevel >= 4" },
            { "G_Balaclava_oli", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_blk", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_khk", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_oli", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_shades", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_sport", "", 2500, "call life_coplevel >= 4" },
            { "G_Bandanna_tan", "", 2500, "call life_coplevel >= 4" }
        };
        vests[] = {
    ...
    class reb {
        ...
        uniforms[] = {
			...
			{ "U_O_Wetsuit", "", 25000, "" },
			{ "U_O_T_Soldier_F", "", 35000, "" },
			{ "U_O_GhillieSuit", "", 35000, "" },
			{ "U_O_T_Sniper_F", "", 35000, "" },
			{ "U_O_T_Officer_F", "", 35000, "" },
