...
_extDB_notLoaded = "";
diag_log "----------------------------------------------------------------------------------------------------";
diag_log "------------------------------ Starting Orion Malden Life Client Init ------------------------------";
...
[0, "Waiting For Anti-Hack....."] call mav_introcam_fnc_updateCinematicStatus;
sleep 0.7;
[0, "Anti-Hack Successfully Initialized!"] call mav_introcam_fnc_updateCinematicStatus;
sleep 3;
...
//organs
player setVariable ["missingOrgan", false, true]; // setsVariables to false on start
...
if (_total > 0) then 
{
    ...
    getOutVehicle = getOutVehicle + _total;
};
[] execVM "Custom\AH\MoneyCheck.sqf";
diag_log "----------------------------------------------------------------------------------------------------";
