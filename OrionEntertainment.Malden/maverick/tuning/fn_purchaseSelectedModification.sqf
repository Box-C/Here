...
if (life_pulloutallplayers < _price) exitWith {
...
if (_subConfig == "RGB" AND _class == "Colors") exitWith {
	...
	// Money duh
 	life_pulloutallplayers = life_pulloutallplayers - _price;
 	mav_tuning_rgbprice = _price;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>You have purchased a modification for <t color='#12FE00'>$%1</t><br/>You have <t color='#12FE00'>$%2</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[life_pulloutallplayers] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
...
if (true) then {
	...
	[_newArray,vehicle player] spawn mav_tuning_fnc_loadVehicleModification;
 	...
 	// Money duh
 	life_pulloutallplayers = life_pulloutallplayers - _price;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>You have purchased a modification for <t color='#12FE00'>$%1</t><br/>You have <t color='#12FE00'>$%2</t> left</t>",[_price] call BIS_fnc_numberText,[life_pulloutallplayers] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
