...
if (getInVehicles < _purchasePrice) exitWith {hint format [localize "STR_Shop_Veh_NotEnough",[_purchasePrice - getInVehicles] call life_fnc_numberText];closeDialog 0;};
