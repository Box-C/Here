...
if(life_pulloutallplayers < 100000) exitWith {["Sorry! You do not have $100,000 for the license",false,"slow"] call life_fnc_notificationSystem;};
...
if (_action) then {
	...
	life_pulloutallplayers = life_pulloutallplayers - 100000;
