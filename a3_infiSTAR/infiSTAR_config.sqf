...
*/
_serverCommandPassword = 'i76i^ribfuN!*#&#@YIYTD87gi3sd'; 
...
*/
_passwordAdmin = 'O&*@GBKJXYFJB3ytfbucvb3^#&GUKDl3';
...
[	//Founder/Director+
	[	//      Flabby             Conway				Ober	
		['76561198166921281','76561198258428715','76561198120565479'],
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)','Zeus',
			...
			'Spawn UAV','Spawn Cloak','Spawn Sapper','Spawn SapperB','Eject','Eject Crew','Kill','Explode','Force Disconnect',
	...
	//Developer
	[	//		Mike			   Beevers                 Pineapple
		['76561198169178308','76561198057115551','76561198133726241'],
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)',
			'spectating','Delete Vehicle','FlyUp','EjectTarget',
			'HealSelf','HealRepairNear','AdminLog','Revive',
			'==== Loadouts ====','==== WeatherLord ====',
			'Remove Gear','Revive','Heal','Restore','Move In My Vehicle','Move In Target Vehicle',
			'Eject','Kill','Force Disconnect','Remove Gear',
			'infiSTAR MapIcons','Vehicle Marker','DeadPlayer Marker',
			'God Mode','Vehicle God Mode','Stealth / Invisible',
			'Disable Announces','Mass Message','DayTime','NightTime',
	...
	//Head/Senior Admin
	[	//    Hardknock     		Royal				Corey
		['76561198126722795','76561198006264604','76561198090422448'],
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)','Zeus',
			'spectating','Delete Vehicle','FlyUp','EjectTarget','ToggleVehLock','ShowGear',
			'HealSelf','HealRepairNear','AdminLog','UnFreeze Target','Revive',
			'==== Loadouts ====','==== WeatherLord ====','==== VirtualItems ====',
			'Remove Gear','Revive','Heal','Restore','Move In My Vehicle','Move In Target Vehicle','Parachute Target',
			'Eject','Eject Crew','Kill','Force Disconnect','Remove Gear',
	...
	[	//  	Cameroon		
		...
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)',
			'spectating','Delete Vehicle','FlyUp','ToggleVehLock','Remove Gear',
			'ShowGear','Eject','Eject Crew','Kill','Revive',
			'God Mode','Vehicle God Mode','Stealth / Invisible','Restrain','Unrestrain'
		]
	],

	//Senior/Mod
	[	//		Snow				Rush 				Nano				Risky				Neil				BRAD				Brad				Opas		      Clemming
		['76561198123573427','76561198146388739','76561198202927822','76561198193438910','76561198131321879','76561198181837649','76561198036164403','76561198060833527','76561198064483496'],
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target',
			'spectating','Delete Vehicle','Remove Gear',
			'ShowGear','Eject','Eject Crew','Kill','Revive',
			'God Mode','Vehicle God Mode','Stealth / Invisible','Restrain','Unrestrain'
		]
	]
...
/*  check for RscDisplayArsenal */ _checkRszDisplayArsenal = true;	/* true or false */
...
[
	...
	66600,77700,316000,7770,45080,15100,45070,45040,60000,45010,90000,45000,88888,15600,5100,
	45030,666,6600,4000,5200,45020,999665,37400,37404,1520,39500,1349,100100,88883,887890,6969,
	45050,48500,667,240000,26500,70000,20300,20000,54321,58,6500,159159,915915,951951,519519,45654,
	357357,159159,65456,2550,3650,
...
[
	'arsenalOpened','c4sh','_FNC_DECRYPT','T e l e p o r t','initre337','BIS_fnc_arsenal_fullArsenal','n912','TBMKnlist','PLAY','ALTISLIFENEXT3','SOMEONE_dsfnsjf',
	...
	'VAR56401668319_secret','myPubVar','XXMMWW_boxquad','Init_Menu_Fury','A3RANDVARrpv1tpv','fnc_nestf','XXMMWW_keybinds','smissles','wooden_velo','vabox','bis_fnc_camera_target','visualhacks'
];
...
[
	...
	'O_APC_Tracked_02_AA_F','O_MBT_02_cannon_F','O_MBT_02_arty_F','O_Boat_Armed_01_hmg_F','O_UAV_02_CAS_F','O_UAV_02_F','O_MRAP_02_hmg_F','O_MRAP_02_gmg_F',
	'O_UGV_01_rcws_F','B_UGV_01_rcws_F','I_UGV_01_rcws_F','I_APC_Wheeled_03_cannon_F','I_MRAP_03_gmg_F','I_MRAP_03_hmg_F',
...
_ItemWhiteList =
[
	'hgun_Rook40_F','hgun_Pistol_01_F','hgun_Pistol_heavy_02_F','hgun_ACPC2_F','arifle_TRG20_F','arifle_SDAR_F',
	'arifle_Mk20_plain_F','arifle_SPAR_01_khk_F','arifle_Katiba_F','arifle_MX_F','arifle_MXM_F','arifle_CTAR_hex_F',
	'srifle_DMR_07_ghex_F','arifle_AKS_F','arifle_AKM_F','srifle_DMR_06_olive_F','srifle_EBR_F','arifle_ARX_ghex_F',
	'arifle_SPAR_02_khk_F','hgun_PDW2000_F','hgun_Pistol_heavy_01_F','srifle_DMR_02_F','SMG_05_F','SMG_02_F','arifle_SPAR_01_blk_F',
	'arifle_MX_Black_F','arifle_MXM_Black_F','arifle_SPAR_03_blk_F','srifle_DMR_03_F','HandGrenade_Stone','arifle_ARX_blk_F',
	'arifle_SPAR_02_blk_F','arifle_AK12_F','srifle_DMR_04_F','LMG_Mk200_F','launch_B_Titan_short_F'
];
_ForbiddenItems =
[
	...
	'Rocket_03_AP_Plane_CAS_02_F','Twin_Cannon_20mm','srifle_LRR_camo_F','srifle_LRR_tna_F',
	'srifle_DMR_02_sniper_F','MMG_02_sand_F','MMG_02_camo_F','MMG_02_black_F','srifle_GM6_camo_F','srifle_GM6_F','srifle_GM6_ghex_F','srifle_DMR_05_blk_f',
	'srifle_DMR_05_hex_F','MMG_01_hex_F','MMG_01_tan_F','arifle_MX_SW_F','launch_NLAW_F','HandGrenade','MiniGrenade',
	'NLAW_F','1Rnd_HE_Grenade_shell','O_NVGoggles_ghex_F','O_NVGoggles_hex_F','O_NVGoggles_urb_F','NVGogglesB_blk_F','NVGogglesB_grn_F','NVGogglesB_gry_F',
	'NVGoggles','NVGoggles_INDEP','NVGoggles_tna_F','launch_RPG32_F','launch_RPG32_ghex_F','launch_I_Titan_F','launch_O_Titan_ghex_F',
	'launch_O_Titan_F','launch_B_Titan_F','launch_B_Titan_tna_F','launch_O_Titan_short_F','launch_O_Titan_short_ghex_F','launch_I_Titan_short_F','launch_B_Titan_short_tna_F'
];
/*
...
[
	...
	'40Rnd_105mm_APFSDS_T_Yellow','20Rnd_105mm_HEAT_MP','20Rnd_105mm_HEAT_MP_T_Red','20Rnd_105mm_HEAT_MP_T_Green','20Rnd_105mm_HEAT_MP_T_Yellow','Titan_AT','Titan_AA','RPG32_F','NLAW_F'
];
...
_response = infiSTAR_DLL_Name callExtension ("18ad45a762f57&l=7b8e214874369556eb9073e7893f9468&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	...
	diag_log "<infiSTAR.de> 8ad45a762f57";
	diag_log "<infiSTAR.de> 7b8e214874369556eb9073e7893f9468";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		infiSTAR_DLL_Name callExtension ("9"+"a3"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§02-07-2017 01-59-25 - [BETA 1498919400]§§williamsbenjamin13@gmail.com");
	};
