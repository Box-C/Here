...
if (_debitPrice > getInVehicles) exitWith {hint format [localize "STR_Debit_NotEnoughCash",[_debitPrice - getInVehicles] call life_fnc_numberText];};
getInVehicles = getInVehicles - _debitPrice;
