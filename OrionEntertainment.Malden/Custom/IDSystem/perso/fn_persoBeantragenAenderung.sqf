...
if(life_pulloutallplayers < _preis) exitWith {hint parseText format ["You do not have enough money.<br/>Current: $%2<br/>Missing: $%1",(_preis - life_pulloutallplayers), life_pulloutallplayers];};
...
if(fvs_namen_a && !(profileName isEqualTo (ctrlText 70002)) && (_erlaubeMehrereNamen isEqualTo 0)) then {
	...
	life_pulloutallplayers = life_pulloutallplayers - _preis;
