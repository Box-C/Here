...
if (life_HC_isActive) then {
    [getPlayerUID player,profileName,getInVehicles,_bank,player] remoteExecCall ["HC_fnc_insertRequest",HC_Life];
} else {
    [getPlayerUID player,profileName,getInVehicles,_bank,player] remoteExecCall ["DB_fnc_insertRequest",RSERV];
};