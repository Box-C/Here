...
switch(_craft) do
{
	case "weapon":
	{
		_return = [
				...
				["srifle_DMR_05_tan_f", ["barrel",5, "trigger",5, "butt",4, "sight",6, "iron_refined",2, "steelplate",3, "sulfur",3, "cloth",4, "steel",10]] //250k - cyrus
        ];
	};
	...
	case "uniform":
	{
         _return = [
				...
				["U_O_FullGhillie_sard",["cloth",13, "steelplate",2 ]], //42.5k - Lush Ghillie
				["U_O_FullGhillie_lsh",["cloth",13, "steelplate",2 ]], //42.5k - Lush Ghillie
				["U_O_T_FullGhillie_tna_F",["cloth",13, "steelplate",2 ]], //42.5k - Lush Ghillie
				["U_O_FullGhillie_ard",["cloth",13, "steelplate",2 ]], //42.5k - Lush Ghillie
    ...
    case "ammo":
    {
        _return = [
				...
				["10Rnd_93x64_DMR_05_Mag",["BTip",3, "BShell",3, "BPowder",3, "BPrimer",3 ]] //6k - cyrus 9.3 rounds
      	];
    };
