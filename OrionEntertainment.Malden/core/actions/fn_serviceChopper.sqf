...
if (getInVehicles < _serviceCost) exitWith {[localize "STR_Serive_Chopper_NotEnough",true,"slow"] call life_fnc_notificationSystem;};
...
getInVehicles = getInVehicles - _serviceCost;
